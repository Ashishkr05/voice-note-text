        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex flex-wrap gap-4 justify-center">
            <button
              ...
              } px-6 py-3 rounded-lg flex items-center gap-2 font-semibold transition-all transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none`}
            >
              {isRecording ? (
            ...
            <button
              ...
              className="px-6 py-3 rounded-lg border border-gray-600 hover:bg-gray-700 flex items-center gap-2 font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Clear All
            </button>
          </div>
          ...
          <div className="w-full mt-8">
            <h3 className="text-xl font-semibold mb-6 text-gray-300">Recording History</h3>
